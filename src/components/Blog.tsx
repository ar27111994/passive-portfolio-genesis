...
const Blog = () => {
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              ...
              <p className="text-destructive mb-4">Error loading blog content: {error}</p>
  ...
  // If no content exists, show generation option
  if (statistics.length === 0 && featuredPosts.length === 0 && recentPosts.length === 0) {
    return (
      <section id="blog" className="py-20">
        <div className="container mx-auto px-4">
